...
const PROJECTS: Project[] = [
  ...
  },
  {
    name: "Freed CRM",
    description:
      "Full-stack CRM built for a Smartsheet consulting firm. Contacts, drag-and-drop Kanban pipeline with deal aging badges (yellow 8d+, red 15d+), activity log, and task tracker. Service package catalog auto-fills deal value. AI Proposal Generator writes full client proposals via Claude. Post-sale milestone tracker (Kickoff → Live) activates on Won deals. Win/Loss reason capture with stage history timeline. Revenue reports with monthly charts, win rate, weighted probability forecast, and leads-by-source breakdown. Company Accounts view groups contacts and deals by org. Email Templates with {{placeholder}} substitution and AI personalization. Smartsheet qualification fields (plan, team size, integrations) on each contact. Global ⌘K search across contacts and deals. Stale deal alerts on dashboard for deals with no activity in 14+ days. Public client intake form creates contacts and leads automatically.",
